...
public class MaxSalaryPerDept extends Configured implements Tool {

	public static void main(String[] args) throws Exception {
		int runStatus = ToolRunner.run(new Configuration(), new MaxSalaryPerDept(), args);
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "MaxSalaryPerDept");
		job.setJobName("MaxSalaryPerDept");
		...
		FileStatus[] sourceListFiles = fileSystem
				.listStatus(new Path("hdfs:///bigdatapgp/common_folder/assignment3/maxsalary/"));
